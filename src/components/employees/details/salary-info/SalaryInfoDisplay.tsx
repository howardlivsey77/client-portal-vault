  ...
  return (
    <div className="space-y-4">
      <div className="grid grid-cols-2 gap-4">
        ...
        <div>
          ...
          <p className="font-medium">
            {calculateMonthlySalary(employee.hourly_rate ?? 0, employee.hours_per_week ?? 40).toFixed(2)}
          </p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-2 gap-4">
        ...
        <div>
          <p className="text-sm text-muted-foreground">Standard Overtime</p>
          <p className="font-medium">
      ...
      <div className="grid grid-cols-2 gap-4">
        <div>
          <p className="text-sm text-muted-foreground">Enhanced Access</p>
          <p className="font-medium">
