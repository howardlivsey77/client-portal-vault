...
import { SicknessReportFilters as FilterType } from "@/hooks/useSicknessReport";
...
export function SicknessReportFilters({ filters, onFiltersChange, departments }: SicknessReportFiltersProps) {
  ...
  const hasActiveFilters = filters.searchTerm || filters.department;
      ...
      <div className="flex flex-col sm:flex-row gap-4">
        ...
        <Select value={filters.sortBy} onValueChange={handleSortChange}>
          ...
          <SelectContent>
            ...
            <SelectItem value="service">Service Months</SelectItem>
          </SelectContent>
        </Select>
