  ...
  return <aside className={cn("fixed inset-y-0 left-0 z-50 flex w-64 flex-col bg-white transition-transform duration-300 ease-in-out lg:static", isOpen ? "translate-x-0" : "-translate-x-full lg:translate-x-0")}>
      ...
      <nav className="flex flex-1 flex-col py-6">
        ...
        <div className="mt-2 space-y-1 px-2">
          <Button variant="ghost" className={cn("monday-sidebar-item w-full justify-start", isTabActive("overview") && "bg-accent text-accent-foreground")} asChild>
          ...
          <Button variant="ghost" className={cn("monday-sidebar-item w-full justify-start", location.pathname.includes("/employees") && "bg-accent text-accent-foreground")} asChild>
            <Link to="/employees">
        ...
        <div className="mt-auto px-2 space-y-1">
          <Button variant="ghost" className={cn("monday-sidebar-item w-full justify-start", location.pathname.includes("/invites") && "bg-accent text-accent-foreground")} asChild>
            <Link to="/invites">
              <Users className="h-4 w-4" />
              Team Access
            </Link>
