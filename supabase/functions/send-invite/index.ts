...
const handler = async (req: Request): Promise<Response> => {
  ...
  try {
    ...
    console.log(JSON.stringify({ 
      evt: "invite.start.compatibility", 
      reqId, 
      ...
      note: "Using compatibility function for cached clients",
    ...
    console.log(JSON.stringify({
      evt: "invite.generate_link_start",
      reqId,
      email: email.toLowerCase().trim(),
      redirectUrl,
      function: "send-invite",
    ...
    console.log(JSON.stringify({
      evt: "invite.success.compatibility",
      reqId,
      email: email.toLowerCase().trim(),
      company_id,
      role,
      ...
      function: "send-invite",
      emailProvider: "mailgun",
      note: "Successfully processed via compatibility function with Mailgun",
      timestamp: new Date().toISOString()
    }));
    ...
    console.error(JSON.stringify({
      evt: "invite.error.compatibility",
      reqId,
