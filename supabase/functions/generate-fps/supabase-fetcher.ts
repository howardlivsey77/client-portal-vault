...
export async function fetchPayrollResults(
  ...
  return data.map((row: Record<string, unknown>) => ({
    ...
    taxable_pay: row.taxable_pay_this_period,
    income_tax: row.income_tax_this_period,
    net_pay: row.net_pay_this_period,
    nic_employee: row.nic_employee_this_period,
    nic_employer: row.nic_employer_this_period,
    employee_pension: row.employee_pension_this_period,
    employer_pension: row.employer_pension_this_period,
    student_loan: row.student_loan_this_period,
    gross_pay: row.gross_pay_this_period,
    smp: null,
    spp: null,
    sap: null,
    shpp: null,
    taxable_pay_ytd: row.taxable_pay_ytd,
    income_tax_ytd: row.income_tax_ytd,
    nic_employee_ytd: row.nic_employee_ytd,
    nic_employer_ytd: row.nic_employer_ytd,
    gross_earnings_for_nics_ytd: row.gross_earnings_for_nics_ytd,
    earnings_at_lel_ytd: row.earnings_at_lel_ytd,
    earnings_lel_to_pt_ytd: row.earnings_lel_to_pt_ytd,
    earnings_pt_to_uel_ytd: row.earnings_pt_to_uel_ytd,
    student_loan_ytd: row.student_loan_ytd,
    employee_pension_ytd: row.employee_pension_ytd,
    nhs_pension_employee_ytd: row.nhs_pension_employee_ytd,
    nhs_pension_employer_ytd: row.nhs_pension_employer_ytd,
    smp_ytd: null,
    spp_ytd: null,
    sap_ytd: null,
    shpp_ytd: null,
